...
LangString inst_qbt_req ${LANG_DUTCH} "qSneedTorrent (vereist)"
...
LangString inst_startup ${LANG_DUTCH} "qSneedTorrent starten bij opstarten van Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with qSneedTorrent"
LangString inst_torrent ${LANG_DUTCH} "Torrentbestanden openen met qSneedTorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with qSneedTorrent"
LangString inst_magnet ${LANG_DUTCH} "Magneetkoppelingen openen met qSneedTorrent"
...
LangString inst_warning ${LANG_DUTCH} "qSneedTorrent is actief. Sluit het af voordat u deze update installeert."
...
LangString launch_qbt ${LANG_DUTCH} "qSneedTorrent starten."
...
LangString inst_requires_win7 ${LANG_DUTCH} "Deze versie van qSneedTorrent vereist ten minste Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall qSneedTorrent"
LangString inst_uninstall_link_description ${LANG_DUTCH} "Uninstall qSneedTorrent"
...
LangString uninst_warning ${LANG_DUTCH} "qSneedTorrent is actief. Sluit het af voordat u het verwijdert."
