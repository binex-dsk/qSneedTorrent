...
LangString inst_qbt_req ${LANG_GERMAN} "qSneedTorrent (erforderlich)"
...
LangString inst_startup ${LANG_GERMAN} "qSneedTorrent mit Windows starten"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with qSneedTorrent"
LangString inst_torrent ${LANG_GERMAN} "Öffne .torrent-Dateien mit qSneedTorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with qSneedTorrent"
LangString inst_magnet ${LANG_GERMAN} "Öffne Magnet-Links mit qSneedTorrent"
...
LangString inst_warning ${LANG_GERMAN} "qSneedTorrent läuft gerade. Bitte das Programm vor der Installation beenden."
...
LangString launch_qbt ${LANG_GERMAN} "Starte qSneedTorrent."
...
LangString inst_requires_win7 ${LANG_GERMAN} "Diese Version von qSneedTorrent erfordert mindestens Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall qSneedTorrent"
LangString inst_uninstall_link_description ${LANG_GERMAN} "qSneedTorrent deinstallieren"
...
LangString uninst_warning ${LANG_GERMAN} "qSneedTorrent läuft gerade. Bitte das Programm vor der Deinstallation beenden."
