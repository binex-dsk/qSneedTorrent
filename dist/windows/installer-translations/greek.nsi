...
LangString inst_qbt_req ${LANG_GREEK} "qSneedTorrent (απαιτείται)"
...
LangString inst_startup ${LANG_GREEK} "Ξεκινήστε το qSneedTorrent στα Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with qSneedTorrent"
LangString inst_torrent ${LANG_GREEK} "Άνοιγμα των αρχείων .torrent με το qSneedTorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with qSneedTorrent"
LangString inst_magnet ${LANG_GREEK} "Άνοιγμα των μαγνητικών συνδέσμων με το qSneedTorrent"
...
LangString inst_warning ${LANG_GREEK} "Το qSneedTorrent βρίσκεται σε εκτέλεση. Παρακαλούμε κλείστε την εφαρμογή πριν την εγκατάσταση."
...
LangString launch_qbt ${LANG_GREEK} "Εκκίνηση του qSneedTorrent."
...
LangString inst_requires_win7 ${LANG_GREEK} "This qSneedTorrent version requires at least Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall qSneedTorrent"
LangString inst_uninstall_link_description ${LANG_GREEK} "Uninstall qSneedTorrent"
...
LangString uninst_warning ${LANG_GREEK} "Το qSneedTorrent βρίσκεται σε εκτέλεση. Παρακαλούμε κλείστε την εφαρμογή πριν την απεγκατάσταση."
