...
LangString inst_qbt_req ${LANG_SPANISH} "qSneedTorrent (necesario)"
...
LangString inst_startup ${LANG_SPANISH} "Iniciar qSneedTorrent en el inicio de Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with qSneedTorrent"
LangString inst_torrent ${LANG_SPANISH} "Abrir archivos .torrent con qSneedTorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with qSneedTorrent"
LangString inst_magnet ${LANG_SPANISH} "Abrir enlaces magnet con qSneedTorrent"
...
LangString inst_warning ${LANG_SPANISH} "qSneedTorrent se está ejecutando. Ciérrelo antes de continuar."
...
LangString launch_qbt ${LANG_SPANISH} "Iniciar qSneedTorrent."
...
LangString inst_requires_win7 ${LANG_SPANISH} "Esta versión de qSneedTorrent requiere Windows 7 o superior."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall qSneedTorrent"
LangString inst_uninstall_link_description ${LANG_SPANISH} "Desinstalar qSneedTorrent"
...
LangString uninst_warning ${LANG_SPANISH} "qSneedTorrent se está ejecutando. Ciérrelo antes de continuar."
