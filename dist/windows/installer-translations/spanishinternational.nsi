...
LangString inst_qbt_req ${LANG_SPANISHINTERNATIONAL} "qSneedTorrent (necesario)"
...
LangString inst_startup ${LANG_SPANISHINTERNATIONAL} "Iniciar qSneedTorrent en el inicio de Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with qSneedTorrent"
LangString inst_torrent ${LANG_SPANISHINTERNATIONAL} "Abrir archivos .torrent con qSneedTorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with qSneedTorrent"
LangString inst_magnet ${LANG_SPANISHINTERNATIONAL} "Abrir enlaces magnet con qSneedTorrent"
...
LangString inst_warning ${LANG_SPANISHINTERNATIONAL} "qSneedTorrent se está ejecutando. Ciérrelo antes de continuar."
...
LangString launch_qbt ${LANG_SPANISHINTERNATIONAL} "Iniciar qSneedTorrent."
...
LangString inst_requires_win7 ${LANG_SPANISHINTERNATIONAL} "Esta versión de qSneedTorrent requiere Windows 7 o superior."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall qSneedTorrent"
LangString inst_uninstall_link_description ${LANG_SPANISHINTERNATIONAL} "Desinstalar qSneedTorrent"
...
LangString uninst_warning ${LANG_SPANISHINTERNATIONAL} "qSneedTorrent se está ejecutando. Ciérrelo antes de continuar."
