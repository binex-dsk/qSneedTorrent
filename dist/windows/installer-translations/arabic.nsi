...
LangString inst_qbt_req ${LANG_ARABIC} "qSneedTorrent (مطلوب)"
...
LangString inst_startup ${LANG_ARABIC} "بدء qSneedTorrent على ويندوز بدء التشغيل"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with qSneedTorrent"
LangString inst_torrent ${LANG_ARABIC} "فتح ملفات التورنت باستخدام qSneedTorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with qSneedTorrent"
LangString inst_magnet ${LANG_ARABIC} "فتح الروابط المغناطيسية باستخدام qSneedTorrent"
...
LangString inst_requires_win7 ${LANG_ARABIC} "This qSneedTorrent version requires at least Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall qSneedTorrent"
LangString inst_uninstall_link_description ${LANG_ARABIC} "Uninstall qSneedTorrent"
