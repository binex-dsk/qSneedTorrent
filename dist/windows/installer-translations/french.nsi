...
LangString inst_qbt_req ${LANG_FRENCH} "qSneedTorrent (requis)"
...
LangString inst_startup ${LANG_FRENCH} "Démarrez qSneedTorrent au démarrage de Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with qSneedTorrent"
LangString inst_torrent ${LANG_FRENCH} "Ouvrir fichiers .torrent avec qSneedTorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with qSneedTorrent"
LangString inst_magnet ${LANG_FRENCH} "Ouvrir liens magnet avec qSneedTorrent"
...
LangString inst_warning ${LANG_FRENCH} "qSneedTorrent est en cours d'exécution. Veuillez fermer l'application avant l'installation."
...
LangString launch_qbt ${LANG_FRENCH} "Lancer qSneedTorrent."
...
LangString inst_requires_win7 ${LANG_FRENCH} "Cette version de qSneedTorrent nécessite au moins Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall qSneedTorrent"
LangString inst_uninstall_link_description ${LANG_FRENCH} "Uninstall qSneedTorrent"
...
LangString uninst_warning ${LANG_FRENCH} "qSneedTorrent est en cours d'exécution. Veuillez fermer l'application avant la désinstallation."
