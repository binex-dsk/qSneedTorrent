...
LangString inst_qbt_req ${LANG_TURKISH} "qSneedTorrent (zorunlu)"
...
LangString inst_startup ${LANG_TURKISH} "Windows başlangıcında qSneedTorrent'i başlat"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with qSneedTorrent"
LangString inst_torrent ${LANG_TURKISH} ".torrent dosyalarını qSneedTorrent ile aç"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with qSneedTorrent"
LangString inst_magnet ${LANG_TURKISH} "Magnet bağlantılarını qSneedTorrent ile aç"
...
LangString inst_warning ${LANG_TURKISH} "qSneedTorrent çalışıyor. Lütfen yüklemeden önce uygulamayı kapatın."
...
LangString launch_qbt ${LANG_TURKISH} "qSneedTorrent'i başlat"
...
LangString inst_requires_win7 ${LANG_TURKISH} "Bu qSneedTorrent sürümü en az Windows 7 gerektirir."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall qSneedTorrent"
LangString inst_uninstall_link_description ${LANG_TURKISH} "qSneedTorrent'i kaldır"
...
LangString uninst_warning ${LANG_TURKISH} "qSneedTorrent çalışıyor. Lütfen kaldırmadan önce uygulamayı kapatın."
