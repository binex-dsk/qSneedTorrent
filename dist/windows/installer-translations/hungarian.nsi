...
LangString inst_qbt_req ${LANG_HUNGARIAN} "qSneedTorrent (kötelező)"
...
LangString inst_startup ${LANG_HUNGARIAN} "qSneedTorrent indítása Windows indításakor"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with qSneedTorrent"
LangString inst_torrent ${LANG_HUNGARIAN} ".torrent fájlok megnyitása qSneedTorrenttel"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with qSneedTorrent"
LangString inst_magnet ${LANG_HUNGARIAN} "Magnet linkek megnyitása qSneedTorrenttel"
...
LangString inst_warning ${LANG_HUNGARIAN} "A qSneedTorrent fut. Kérem zárjba be az alkalmazást a telepítés előtt."
...
LangString launch_qbt ${LANG_HUNGARIAN} "qSneedTorrent indítása."
...
LangString inst_requires_win7 ${LANG_HUNGARIAN} "A qSneedTorrent ezen verziójához minimum Windows 7 szükséges."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall qSneedTorrent"
LangString inst_uninstall_link_description ${LANG_HUNGARIAN} "qSneedTorrent eltávolítása"
...
LangString uninst_warning ${LANG_HUNGARIAN} "A qSneedTorrent jelenleg is fut. Kérem zárja be az alkalmazást mielőtt eltávolítaná."
