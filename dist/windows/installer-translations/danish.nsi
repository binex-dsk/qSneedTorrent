...
LangString inst_qbt_req ${LANG_DANISH} "qSneedTorrent (påkrævet)"
...
LangString inst_startup ${LANG_DANISH} "Start qSneedTorrent når Windows starter"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with qSneedTorrent"
LangString inst_torrent ${LANG_DANISH} "Åbn .torrent-filer med qSneedTorrent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with qSneedTorrent"
LangString inst_magnet ${LANG_DANISH} "Åbn magnet-links med qSneedTorrent"
...
LangString inst_warning ${LANG_DANISH} "qSneedTorrent kører. Luk venligst programmet inden installation."
...
LangString launch_qbt ${LANG_DANISH} "Start qSneedTorrent."
...
LangString inst_requires_win7 ${LANG_DANISH} "qSneedTorrent-versionen kræver mindst Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall qSneedTorrent"
LangString inst_uninstall_link_description ${LANG_DANISH} "Afinstaller qSneedTorrent"
...
LangString uninst_warning ${LANG_DANISH} "qSneedTorrent kører. Luk venligst programmet inden afinstallation."
