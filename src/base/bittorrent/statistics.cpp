...
void Statistics::save() const
{
    ...
    SettingsPtr s = Profile::instance()->applicationSettings(QLatin1String("qSneedTorrent-data"));
    QVariantHash v;
...
{
    const SettingsPtr s = Profile::instance()->applicationSettings(QLatin1String("qSneedTorrent-data"));
