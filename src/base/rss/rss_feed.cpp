 ...
 * Copyright (C) 2010  Arnaud Demaiziere <arnaud@qsneedtorrent.org>
 *
...
{
    const SettingsPtr qBTRSSFeeds = Profile::instance()->applicationSettings(QStringLiteral("qSneedTorrent-rss-feeds"));
