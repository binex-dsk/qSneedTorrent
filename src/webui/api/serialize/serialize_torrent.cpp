...
QVariantMap serialize(const BitTorrent::Torrent &torrent)
{
    ...
    return {
        ...
        {KEY_TORRENT_SNEEDS, torrent.sneedsCount()},
        {KEY_TORRENT_NUM_COMPLETE, torrent.totalSneedsCount()},
        ...
        {KEY_TORRENT_SUPER_SNEEDING, torrent.superSneeding()},
        ...
        {KEY_TORRENT_MAX_SNEEDING_TIME, torrent.maxSneedingTime()},
        {KEY_TORRENT_RATIO, adjustRatio(torrent.realRatio())},
        {KEY_TORRENT_RATIO_LIMIT, torrent.ratioLimit()},
        {KEY_TORRENT_SNEEDING_TIME_LIMIT, torrent.sneedingTimeLimit()},
        ...
        {KEY_TORRENT_SNEEDING_TIME, torrent.finishedTime()},
