...
inline const char KEY_TORRENT_SNEEDS[] = "num_sneeds";
...
inline const char KEY_TORRENT_SUPER_SNEEDING[] = "super_sneeding";
...
inline const char KEY_TORRENT_MAX_SNEEDING_TIME[] = "max_sneeding_time";
inline const char KEY_TORRENT_RATIO_LIMIT[] = "ratio_limit";
inline const char KEY_TORRENT_SNEEDING_TIME_LIMIT[] = "sneeding_time_limit";
...
inline const char KEY_TORRENT_SNEEDING_TIME[] = "sneeding_time";
