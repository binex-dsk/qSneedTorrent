...
win32-g++*|win32-clang-g++* {
    ...
    RC_FILE = qsneedtorrent_mingw.rc
    ...
    QMAKE_LFLAGS += "/MANIFEST:EMBED /MANIFESTINPUT:$$quote($${PWD}/src/qsneedtorrent.exe.manifest) /STACK:0x800000"

    RC_FILE = qsneedtorrent.rc
